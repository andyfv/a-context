...
var $author$project$Page$Home$Article = F5(
	function (title, image, href, summary, date) {
		return {date: date, href: href, image: image, summary: summary, title: title};
	});
var $author$project$Page$Home$Image = F2(
...
var $author$project$Page$Home$init = _Utils_Tuple2(
	{
		articles: _List_fromArray(
			[
				A5(
				$author$project$Page$Home$Article,
				'Testing my article',
				A2($author$project$Page$Home$Image, '/img/turtle.png', 'Alan Kay'),
				'/mindstorms/test_arcticle',
				'Just some test text',
				'07 Feb 2020'),
				A5(
				$author$project$Page$Home$Article,
				...
				A5(
				$author$project$Page$Home$Article,
				'Testing my article right now is not very good',
				A2($author$project$Page$Home$Image, '/img/turtle.png', 'Alan Kay'),
				'/mindstorms/test_arcticle',
				'Just some test text',
				'07 Feb 2020'),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		if ((_v0.a.$ === 'HomePage') && (_v0.b.$ === 'HomeMsg')) {
...
var $author$project$Page$Home$viewCardImage = function (image) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Page$Home$viewCardInfo = function (article) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Page$Home$viewCard = function (article) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Page$Home$viewCardImage(article.image),
				$author$project$Page$Home$viewCardInfo(article)
			]));
};
var $author$project$Page$Home$viewCards = function (articles) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Page$Home$viewCard, articles));
};
var $author$project$Page$Home$view = function (model) {
	return $author$project$Page$Home$viewCards(model.articles);
};
