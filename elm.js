...
var $author$project$Main$initialModel = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{
				deviceInfo: A3(
					$author$project$Main$DeviceInfo,
					flags.width,
					flags.height,
					$mdgriffith$elm_ui$Element$classifyDevice(flags)),
				key: key,
				page: $author$project$Page$Page$Home,
				str: '',
				url: url
			},
...
var $author$project$Main$ViewportUpdate = function (a) {
	return {$: 'ViewportUpdate', a: a};
};
	...
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (width, height) {
				return $author$project$Main$ViewportUpdate(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ViewportUpdate':
				...
				var deviceClass = $mdgriffith$elm_ui$Element$classifyDevice(
					{height: height, width: width});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							deviceInfo: A3($author$project$Main$DeviceInfo, width, height, deviceClass)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Update':
				var str = msg.a;
...
var $author$project$Main$desktopHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$height(
			$mdgriffith$elm_ui$Element$px(58)),
			$mdgriffith$elm_ui$Element$Background$color(
			A3($mdgriffith$elm_ui$Element$rgb255, 255, 185, 0)),
	...
	_List_fromArray(
		[
			...
			{description: 'logo', src: '/img/blog_desktop_dark.svg'}),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							A3($mdgriffith$elm_ui$Element$rgb255, 81, 75, 69)),
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Mindstorms'),
						url: '/mindstorms'
					})
				]))
		]));
...
var $author$project$Main$headerWrapper = A2(
	...
	$author$project$Main$desktopHeader);
...
var $author$project$Main$desktopBody = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$tiled('/img/background_noise.png'),
				$mdgriffith$elm_ui$Element$inFront($author$project$Main$headerWrapper)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$core$Debug$toString(model.deviceInfo))
					]))
			]));
};
...
var $author$project$Main$mobileHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		[
			...
			_List_fromArray(
				[
					...
					{description: 'logo', src: '/img/icon_mobile_dark.svg'}),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					{description: 'menu', src: '/img/menu_icon_dark.svg'}),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
var $author$project$Main$mobileBody = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$tiled('/img/background_noise.png'),
				$mdgriffith$elm_ui$Element$inFront($author$project$Main$mobileHeader)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$moveDown(300)
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
...
var $author$project$Main$bodyDispatcher = F2(
	function (model, deviceClass) {
		switch (deviceClass.$) {
			case 'Desktop':
				return $author$project$Main$desktopBody(model);
			case 'Phone':
				return $author$project$Main$mobileBody(model);
			case 'Tablet':
				return $author$project$Main$desktopBody(model);
			default:
				return $author$project$Main$desktopBody(model);
...
var $author$project$Main$view = function (model) {
	var deviceClass = model.deviceInfo.deviceType._class;
	return {
		body: _List_fromArray(
			[
				...
				_List_Nil,
				A2($author$project$Main$bodyDispatcher, model, deviceClass))
			]),
		title: 'Z Context'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$initialModel, onUrlChange: $author$project$Main$UrlChanged, onUrlRequest: $author$project$Main$LinkClicked, subscriptions: $author$project$Main$subscription, update: $author$project$Main$update, view: $author$project$Main$view});
