	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$hr, _List_Nil, _List_Nil),
				A2($author$project$Center$markdown, '800px', $author$project$Projects$DiscoverSofia$part1),
				A2(
				$elm$html$Html$p,
				$author$project$Center$styles('800px'),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/z-context/img/projects/discover-sofia/app-arch.png'),
								$elm$html$Html$Attributes$alt('App Arhitecture')
							]),
						_List_Nil)
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/z-context/img/projects/discover-sofia/model-accuracy.png'),
								$elm$html$Html$Attributes$alt('Model Accuracy')
							]),
						_List_Nil)
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/z-context/img/projects/discover-sofia/app-comms.png'),
								$elm$html$Html$Attributes$alt('App Communications')
							]),
						_List_Nil)
					])),
				A2($author$project$Center$markdown, '800px', $author$project$Projects$DiscoverSofia$part4),
				A2(
				$elm$html$Html$p,
				$author$project$Center$styles('800px'),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/z-context/img/projects/discover-sofia/app.png'),
								$elm$html$Html$Attributes$alt('App')
							]),
						_List_Nil)
					])),
				A2($author$project$Center$markdown, '800px', $author$project$Projects$DiscoverSofia$part5)
			]));
};
