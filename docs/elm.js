	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Center$markdown, '800px', '![App Communications](/z-context/img/projects/discover-sofia/app-comms.png)'),
				A2($author$project$Center$markdown, '800px', $author$project$Projects$DiscoverSofia$part4),
				A2($author$project$Center$markdown, '800px', '![App](/z-context/img/projects/discover-sofia/app.png)'),
